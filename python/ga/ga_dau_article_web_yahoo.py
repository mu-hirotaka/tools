...
def main():
  ...
  csv_filename = "./csv/ga_dau_article_web_yahoo_" + exec_date_str + ".csv"
  ...
  schema_filename = './schema/event_dau_article_web_yahoo.txt'
  tablename_prefix = 'dau_article_web_yahoo_'
